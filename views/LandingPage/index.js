      ...
      <View style={styles.container}>
        <ScrollView>
          <View style={styles.banner}>
            <Image style={styles.img} source={require('./landing.png')} />
            <View style={styles.centered}>
              <Text style={styles.paragraph}>
                База компаній громадської ініціативи
              </Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionBody}>
              ...
              Скористайтесь нашим пошуком по сферах. Оберіть сферу послуг, що
              вас цікавить, серед списку зліва на сторінці
            </Text>
          </View>
        </ScrollView>
      </View>
